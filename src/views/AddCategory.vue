    ...
    <section class="container">
      <div class="columns is-flex-wrap-wrap" v-if="category_data[0]">
        <div
          ...
          v-for="cat in category_data[0].category"
          :key="cat.id"
        >
          <div class="column">
            <figure class="image">
              <img :src="cat.get_thumbnail" :alt="cat.id" />
            </figure>
            <div
...
const add_category = async () => {
  ...
  model_type.value === "category"
    ? await axios
        .post(`api/v1/admin/category/1`, fm)
        .then((res) => {
          msg_add_category_.value = res.data.msg;
          add_category_.value = "";
        ...
        .catch((e) => console.log(e))
    : await axios
        .patch(`api/v1/admin/category/` + edit_id.value, fm)
        .then((res) => {
          store.dispatch("fetchAdmin");
          add_category_.value = "";
          add_category_slug.value = "";
