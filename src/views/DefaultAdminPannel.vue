      ...
      <div class="column">
        <div class="box">
          ...
          <div class="level">
            <div class="level-item">
              <div class="">
                <div class="heading" v-for="da in data" :key="da">
                  {{ da }}
                </div>
        ...
        <div class="panel">
          ...
          <div class="panel-block">
            <figure class="image is-16x9">
              <!-- <img src="https://placeholder.org/1280x720" /> -->
            </figure>
          </div>
        </div>
      </div>
...
let data = computed(() => store.getters.getAdminData);
data.value.length ? "" : store.dispatch("fetchAdmin");
</script>
<style Scoped></style>
